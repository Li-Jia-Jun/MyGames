    ...
    ui(new Ui::MainWindow), cHelp()
{
    ...
    connect(ui->mygl, SIGNAL(sig_sendPlayerSpeed(QString)), &playerInfoWindow, SLOT(slot_setSpeedText(QString)));
    connect(ui->mygl, SIGNAL(sig_sendPlayerMode(QString)), &playerInfoWindow, SLOT(slot_setModeText(QString)));
    connect(ui->mygl, SIGNAL(sig_sendPlayerGround(QString)), &playerInfoWindow, SLOT(slot_setGroundText(QString)));
