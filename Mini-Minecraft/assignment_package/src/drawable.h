...
// Drawable that supports additional attributes for transparent objects
class TransparentDrawable : public Drawable
{
protected:
    int m_TransCount;
...
public:
    TransparentDrawable(OpenGLContext* mp_context);
